...
describe('The jQuery Gerbera Editor Overlay', function () {
  'use strict'
  var editObjectType
  var editTitle
  var editLocation
  ...
  describe('addNewItem()', function () {
    it('defaults fields based on type', function () {
    ...
    it('makes object type enabled and not readonly', function () {
      $('#editModal').editmodal('addNewItem', {type: 'container', item: item})
    ...
    it('defaults editable fields when item selected', function () {
    ...
    it('defaults editable fields when active_item is selected', function () {
    ...
    it('defaults editable fields when external_url is selected', function () {
    ...
    it('defaults editable fields when internal_url is selected', function () {
    ...
    it('binds the onSave event to the Add button', function () {
      var saveSpy = jasmine.createSpy('save')
      var itemData = {type: 'internal_url', item: item, onSave: saveSpy}
  ...
  describe('reset()', function () {
    it('should reset fields to empty', function () {
    ...
    it('should hide parent and object ID fields', function () {
      $('#editModal').editmodal('reset')
  ...
  describe('loadItem()', function () {
    ...
    it('should set fields in editor for `container`', function () {
      var itemData = {
    ...
    it('should set fields in editor for `item`', function () {
      var itemData = {
    ...
    it('should set fields in editor for `active_item`', function () {
      var itemData = {
    ...
    it('should set fields in editor for `external_url`', function () {
      var itemData = {
    ...
    it('should set fields in editor for `internal_url`', function () {
      var itemData = {
    ...
    it('binds the onSave event to the save button', function () {
      var saveSpy = jasmine.createSpy('save')
      var itemData = {
        item: getJSONFixture('internal-url.json'),
        onSave: saveSpy
  ...
  describe('saveItem()', function () {
    ...
    it('gives proper data for `item` object to save', function () {
      var itemData = { item: getJSONFixture('item.json') }
      editModal.editmodal('loadItem', itemData)

      var result = editModal.editmodal('saveItem')
    ...
    it('gives proper data for `container` object to save', function () {
      var itemData = { item: getJSONFixture('container.json') }
      editModal.editmodal('loadItem', itemData)
    ...
    it('gives proper data for `external_url` object to save', function () {
      var itemData = { item: getJSONFixture('external-url.json') }
      editModal.editmodal('loadItem', itemData)
    ...
    it('gives proper data for `internal_url` object to save', function () {
      var itemData = { item: getJSONFixture('internal-url.json') }
      editModal.editmodal('loadItem', itemData)
    ...
    it('gives proper data for `active_item` object to save', function () {
      var itemData = { item: getJSONFixture('active-item.json') }
      editModal.editmodal('loadItem', itemData)
  ...
  describe('addObject()', function () {
    ...
    it('gives proper data for `item` object to add', function () {
      $('#editModal').editmodal('addNewItem', {type: 'item', item: item})

      var result = editModal.editmodal('addObject')
    ...
    it('gives proper data for `container` object to add', function () {
      $('#editModal').editmodal('addNewItem', {type: 'container', item: item})
    ...
    it('gives proper data for `external_url` object to add', function () {
      $('#editModal').editmodal('addNewItem', {type: 'external_url', item: item})
    ...
    it('gives proper data for `internal_url` object to add', function () {
      $('#editModal').editmodal('addNewItem', {type: 'internal_url', item: item})
    ...
    it('gives proper data for `active_item` object to add', function () {
      $('#editModal').editmodal('addNewItem', {type: 'active_item', item: item})
