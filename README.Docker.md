...
e.g. `gerbera/gerbera:2.4.1-transcoding`. Includes tools such as ffmpeg and vlc.
...
$ docker run \
    ...
    -v /some/files:/mnt/content:ro \
     gerbera/gerbera:2.4.1 gerbera --port <your-port> --config /var/run/gerbera/config.xml
```
...
$ docker run \
    ...
    --env GID=<newgid> \
    -v /some/files:/mnt/content:ro \
     gerbera/gerbera:2.4.1 gerbera --config /var/run/gerbera/config.xml
```
