...
- src/config/config_generator.cc: Add here if you want it to be part of the generated default config or example config file. In this case do not forget to updated the fixtures under test/config/fixtures
