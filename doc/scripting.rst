...
Media and Container Classes:
    ...
    +---------------------------------------+---------+--------------------------------------+-----------------------------------------------+
    | ``UPNP_CLASS_CONTAINER_ALBUM``        | string  | object.container.album               |                                               |
    +---------------------------------------+---------+--------------------------------------+-----------------------------------------------+
...
For default Photo Layout:
    ...
    +---------------------------------------+---------------------------------+
    | ``BK_imageAllModels``                 | ImageDetail/allModels           |
    +---------------------------------------+---------------------------------+
    | ``BK_imageYearMonth``                 | ImageDetail/yearMonth           |
    +---------------------------------------+---------------------------------+
    | ``BK_imageYearDate``                  | ImageDetail/yearDate            |
    +---------------------------------------+---------------------------------+

For default combined Photo and Video Layout:
    +---------------------------------------+---------------------------------+
    | Constant                              | Value                           |
    +=======================================+=================================+
    | ``BK_topicRoot``                      | Topic/topicRoot                 |
    +---------------------------------------+---------------------------------+
    | ``BK_topic``                          | Topic/topic                     |
    +---------------------------------------+---------------------------------+
    | ``BK_topicExtra``                     | Topic/topicExtra                |
    +---------------------------------------+---------------------------------+
