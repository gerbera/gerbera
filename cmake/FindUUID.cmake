    ...
    if(PC_UUID_FOUND)
        ...
        if(UUID_INCLUDE_DIRS)
            ...
            if(NOT TARGET UUID::UUID)
                add_library(UUID::UUID INTERFACE IMPORTED)
                set_property(TARGET UUID::UUID PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                                                        "${UUID_INCLUDE_DIRS}")
                set_property(TARGET UUID::UUID PROPERTY INTERFACE_LINK_LIBRARIES
                                                        "${UUID_LIBRARIES}")
            endif()
