...
if(EXISTS ${NPUPNP_INCLUDE_DIR}/upnpconfig.h)
    file(STRINGS ${NPUPNP_INCLUDE_DIR}/upnpconfig.h npupnp_ver_str
         REGEX "^#define[ \t]+NPUPNP_VERSION_STRING[ \t]+\".+\"")
    string(REGEX REPLACE "^#define[ \t]+NPUPNP_VERSION_STRING[ \t]+\"([^\"]+)\".*" "\\1"
                         NPUPNP_VERSION "${npupnp_ver_str}")
endif()
...
if(NPUPNP_FOUND)
    if(NOT TARGET NPUPNP::NPUPNP)
        ...
        set_target_properties(
            NPUPNP::NPUPNP
            PROPERTIES IMPORTED_LOCATION ${NPUPNP_LIBRARY}
...
mark_as_advanced(
    NPUPNP_INCLUDE_DIR NPUPNP_LIBRARY)
