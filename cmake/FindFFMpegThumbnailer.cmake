...
set(FFMPEGTHUMBNAILER_VERSION ${PC_FFTHUMB_VERSION})
...
find_file(
    _ffmpegthumbnailer_pkg_config_file
...
if(EXISTS ${_ffmpegthumbnailer_pkg_config_file})
    file(STRINGS "${_ffmpegthumbnailer_pkg_config_file}" _ffmpegthumbnailer_version
         REGEX "^Version: .*$")
    string(REGEX REPLACE "^.*Version: ([0-9]+).*$" "\\1" FFMPEGTHUMBNAILER_VERSION_MAJOR
                         "${_ffmpegthumbnailer_version}")
    string(REGEX REPLACE "^.*Version: [0-9]+\\.([0-9]+).*$" "\\1" FFMPEGTHUMBNAILER_VERSION_MINOR
                         "${_ffmpegthumbnailer_version}")
    string(REGEX REPLACE "^.*Version: [0-9]+\\.[0-9]+\\.([0-9]+).*$" "\\1"
                         FFMPEGTHUMBNAILER_VERSION_PATCH "${_ffmpegthumbnailer_version}")
    set(FFMPEGTHUMBNAILER_VERSION_STRING
        "${FFMPEGTHUMBNAILER_VERSION_MAJOR}.${FFMPEGTHUMBNAILER_VERSION_MINOR}.${FFMPEGTHUMBNAILER_VERSION_PATCH}"
    )
...
mark_as_advanced(
    FFMPEGTHUMBNAILER_INCLUDE_DIR FFMPEGTHUMBNAILER_LIBRARY FFMPEGTHUMBNAILER_VERSION_STRING)
