...
find_path(
    CXXOPTS_INCLUDE_DIR cxxopts.hpp
...
if(CXXOPTS_INCLUDE_DIR)
    ...
    find_path(CXXOPTS_INCLUDE_DIR cxxopts.hpp PATHS "src/contrib/cxxopts")
    set(CXXOPTS_INCLUDE_DIRS ${CXXOPTS_INCLUDE_DIR})
    set(CXXOPTS_VERSION "3.3.1-grb")
...
set_target_properties(cxxopt::cxxopt PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
