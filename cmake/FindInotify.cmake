...
find_path(
    Inotify_INCLUDE_DIRS sys/inotify.h)

if(Inotify_INCLUDE_DIRS)
    # On Linux there is no library to link against, on the BSDs there is. On the BSD's, inotify is
    # implemented through a library, libinotify.
    if(CMAKE_SYSTEM_NAME MATCHES "Linux" OR CMAKE_SYSTEM_NAME MATCHES "SunOS")
        ...
        find_package_handle_standard_args(
            ...
            REQUIRED_VARS Inotify_LIBRARIES Inotify_INCLUDE_DIRS)
    ...
    if(NOT TARGET Inotify::Inotify)
        ...
        set_property(TARGET Inotify::Inotify PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                                                      "${Inotify_INCLUDE_DIRS}")
...
mark_as_advanced(
    Inotify_LIBRARIES Inotify_INCLUDE_DIRS)
