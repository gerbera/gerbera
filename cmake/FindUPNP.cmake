...
find_path(
    UPNP_INCLUDE_DIR upnp.h
    HINTS ${PC_UPNP_INCLUDEDIR} ${PC_UPNP_INCLUDEDIR}/upnp ${PC_UPNP_INCLUDE_DIRS})
...
if(EXISTS ${UPNP_INCLUDE_DIR}/upnpconfig.h)
    file(STRINGS ${UPNP_INCLUDE_DIR}/upnpconfig.h upnp_ver_str
         REGEX "^#define[ \t]+UPNP_VERSION_STRING[ \t]+\".+\"")
    string(REGEX REPLACE "^#define[ \t]+UPNP_VERSION_STRING[ \t]+\"([^\"]+)\".*" "\\1" UPNP_VERSION
                         "${upnp_ver_str}")
endif()
...
if(UPNP_FOUND)
    if(NOT TARGET UPNP::UPNP)
        ...
        set_target_properties(
            UPNP::UPNP
            PROPERTIES IMPORTED_LOCATION ${UPNP_UPNP_LIBRARY}
...
mark_as_advanced(
    UPNP_INCLUDE_DIR UPNP_IXML_LIBRARY UPNP_UPNP_LIBRARY)
