...
TEST_F(UpnpXmlTest, RenderObjectItemWithResources)
{
    ...
    expectedXml << "<sec:CaptionInfoEx protocolInfo=\"http-get:*:srt:*\" sec:type=\"srt\">http://server/content/media/object_id/42/res_id/1/rct/vs/type/srt/ext/file.srt</sec:CaptionInfoEx>\n";
    ...
    expectedXml << "<res protocolInfo=\"http-get:*:srt:DLNA.ORG_OP=01;DLNA.ORG_CI=0;DLNA.ORG_FLAGS=00d00000000000000000000000000000\">http://server/content/media/object_id/42/res_id/1/group/default/rct/vs/type/srt/ext/file.srt</res>\n";
    expectedXml << "</item>\n";
    expectedXml << "</DIDL-Lite>\n";
