...
public:
    ...
    virtual duk_ret_t addCdsObject(map<string, string> item, string containerChain, string objectType) = 0;
...
public:
    ...
    MOCK_METHOD1(addContainerTree, duk_ret_t(vector<string> tree));
    ...
    MOCK_METHOD3(addCdsObject, duk_ret_t(map<string, string> item, string containerChain, string objectType));
