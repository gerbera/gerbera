...
- Support for folder/cover.jpg external images for music.
    ...
    - Per-Track art files supported are files named [case-folded and glob] filename-of-track.jp\*, where "name-of-track" is the filename of the track, minus the audio file extension
