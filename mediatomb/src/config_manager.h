...
typedef enum
{
    ...
    CFG_IMPORT_LIBOPTS_FFMPEGTHUMBNAILER_ENABLED,
    CFG_IMPORT_LIBOPTS_FFMPEGTHUMBNAILER_THUMBSIZE,
    CFG_IMPORT_LIBOPTS_FFMPEGTHUMBNAILER_SEEK_PERCENTAGE,
    CFG_IMPORT_LIBOPTS_FFMPEGTHUMBNAILER_FILMSTRIP_OVERLAY,
    CFG_IMPORT_LIBOPTS_FFMPEGTHUMBNAILER_WORKAROUND_BUGS,
#endif
#ifdef EXTERNAL_TRANSCODING
