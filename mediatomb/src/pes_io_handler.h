/*MT*
    ...
    pes_io_handler.h - this dvd is part of MediaTomb.
...
#ifndef __PES_IO_HANDLER_H__
#define __PES_IO_HANDLER_H__
...
class PESIOHandler : public IOHandler
{
public:
    PESIOHandler(zmm::Ref<IOHandler> io_handler, int keep_audio_idx);
