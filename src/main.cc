...
void print_copyright()
{
    ...
    printf("Copyright 2016-2018 Gerbera Contributors.\n");
...
void log_copyright()
{
    ...
    log_info("Copyright 2016-2018 Gerbera Contributors.\n");
...
#ifndef TOMBDEBUG
            print_copyright();
            printf("ERROR: Gerbera wasn't compiled with debug output, but was run with -D/--debug.\n");
            log_error("ERROR: Gerbera wasn't compiled with debug output, but was run with -D/--debug.\n");
            exit(EXIT_FAILURE);
#endif
