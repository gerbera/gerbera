    ...
    : SQLDatabase(config, mime)
{
    ...
    hashies = { 2079400395, 928913698, 1984244483, 2241152998, 1748460509, 2860006966, 974692115, 70310290, 1863649106, 4238128129, 2979337694, 1512596496, 507706380, 3545156190, 31528140, 372163748, 243841107 };
}
