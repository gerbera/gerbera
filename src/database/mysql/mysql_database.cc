    ...
    : SQLDatabase(config, mime, converterManager)
{
    ...
    hashies = {
        3512174326, // index 0 is used for create script mysql.sql = Version 1
        ...
        3643149536, 4280737637, 991351280, 4129183594, 966576288, 1437624385, 2132165886, 2423028702, // upgrade 22-29
