...
// updates 1->2
static constexpr auto MYSQL_UPDATE_1_2_1 = "ALTER TABLE `mt_cds_object` CHANGE `location` `location` BLOB NULL DEFAULT NULL";
static constexpr auto MYSQL_UPDATE_1_2_2 = "ALTER TABLE `mt_cds_object` CHANGE `metadata` `metadata` BLOB NULL DEFAULT NULL";
static constexpr auto MYSQL_UPDATE_1_2_3 = "ALTER TABLE `mt_cds_object` CHANGE `auxdata` `auxdata` BLOB NULL DEFAULT NULL";
static constexpr auto MYSQL_UPDATE_1_2_4 = "ALTER TABLE `mt_cds_object` CHANGE `resources` `resources` BLOB NULL DEFAULT NULL";
static constexpr auto MYSQL_UPDATE_1_2_5 = "ALTER TABLE `mt_autoscan` CHANGE `location` `location` BLOB NULL DEFAULT NULL";

// updates 2->3
static constexpr auto MYSQL_UPDATE_2_3_1 = "ALTER TABLE `mt_autoscan` CHANGE `scan_mode` `scan_mode` ENUM( 'timed', 'inotify' ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL";
static constexpr auto MYSQL_UPDATE_2_3_2 = "ALTER TABLE `mt_autoscan` DROP INDEX `mt_autoscan_obj_id`, ADD UNIQUE `mt_autoscan_obj_id` ( `obj_id` )";
static constexpr auto MYSQL_UPDATE_2_3_3 = "ALTER TABLE `mt_autoscan` ADD `path_ids` BLOB AFTER `location`";

// updates 3->4
static constexpr auto MYSQL_UPDATE_3_4_1 = "ALTER TABLE `mt_cds_object` ADD `service_id` varchar(255) default NULL";
static constexpr auto MYSQL_UPDATE_3_4_2 = "ALTER TABLE `mt_cds_object` ADD KEY `cds_object_service_id` (`service_id`)";

// updates 4->5
static constexpr auto MYSQL_UPDATE_4_5_1 = "CREATE TABLE `mt_metadata` ( "
...
static constexpr auto MYSQL_UPDATE_5_6_1 = "CREATE TABLE `grb_config_value` ( "
                                           "`item` varchar(255) primary key, "
                                           "`key` varchar(255) NOT NULL, "
                                           "`item_value` varchar(255) NOT NULL, "
                                           "`status` varchar(20) NOT NULL) "
                                           "ENGINE=MyISAM CHARSET=utf8";
static constexpr auto MYSQL_UPDATE_5_6_2 = "CREATE INDEX grb_config_value_item ON grb_config_value(item)";

// updates 6->7
static constexpr auto MYSQL_UPDATE_6_7_1 = "DROP TABLE mt_cds_active_item;";

// updates 7->8: part_number
static constexpr auto MYSQL_UPDATE_7_8_1 = "ALTER TABLE `mt_cds_object` ADD `part_number` int(11) default NULL AFTER `flags`";
static constexpr auto MYSQL_UPDATE_7_8_2 = "ALTER TABLE `mt_cds_object` DROP KEY `cds_object_track_number`";
static constexpr auto MYSQL_UPDATE_7_8_3 = "ALTER TABLE `mt_cds_object` ADD KEY `cds_object_track_number` (`part_number`,`track_number`)";

// updates 8->9: bookmark_pos
static constexpr auto MYSQL_UPDATE_8_9_1 = "ALTER TABLE `mt_cds_object` ADD `bookmark_pos` int(11) unsigned NOT NULL default '0' AFTER `service_id`";

// updates 9->10: last_modified
static constexpr auto MYSQL_UPDATE_9_10_1 = "ALTER TABLE `mt_cds_object` ADD `last_modified` bigint(20) unsigned default NULL AFTER `bookmark_pos`";

static constexpr auto MYSQL_UPDATE_VERSION = "UPDATE `mt_internal_setting` SET `value`='{}' WHERE `key`='db_version' AND `value`='{}'";
