    ...
    DbFileType fileType)
{
    ...
    case DbFileType::Any:
        et = std::vector<int> {
            int(CdsEntryType::File),
            int(CdsEntryType::Directory),
            int(CdsEntryType::VirtualContainer),
            int(CdsEntryType::PlaylistContainer),
        };
        break;
    case DbFileType::All:
        et = std::vector<int> {
            ...
            int(CdsEntryType::Directory),
            int(CdsEntryType::VirtualContainer),
            int(CdsEntryType::ExtraFile),
            int(CdsEntryType::ExtraDirectory),
            int(CdsEntryType::PlaylistContainer),
        };
        break;
    }
...
std::vector<int> SQLDatabase::getRefObjects(
    int objectId,
    CdsEntryType entryType)
{
    auto getSql = fmt::format("SELECT {}, {} FROM {} WHERE {} AND {} == {}",
        ...
        browseColumnMapper->mapQuoted(BrowseColumn::EntryType, true), int(entryType));
