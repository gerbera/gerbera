    ...
    , shutdownAttempts(this->config->getIntOption(ConfigVal::SERVER_STORAGE_SQLITE_SHUTDOWN_ATTEMPTS))
{
    ...
    hashies = {
        3342248374, // index 0 is used for create script sqlite3.sql = Version 1
        ...
        3135921396, 3108208, 2156790525, 1240815035, 3165480624, 2252596209, 890824096, 1243527281, // upgrade 22-29
