...
enum config_option_t {
    ...
    CFG_IMPORT_AUTOSCAN_INOTIFY_ATTRIB,
    ...
    CFG_IMPORT_LIBOPTS_FFMPEG_ENABLED,
#endif
#ifdef HAVE_MATROSKA
    CFG_IMPORT_LIBOPTS_MKV_CHARSET,
    CFG_IMPORT_LIBOPTS_MKV_ENABLED,
#endif
#ifdef HAVE_WAVPACK
    CFG_IMPORT_LIBOPTS_WVC_CHARSET,
    CFG_IMPORT_LIBOPTS_WVC_ENABLED,
#endif
    CFG_CLIENTS_LIST,
    ...
    ATTR_AUTOSCAN_DIRECTORY_RETRYCOUNT,
