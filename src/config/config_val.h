...
enum class ConfigVal {
    ...
    IMPORT_SCRIPTING_IMPORT_LAYOUT_TRAILER,
...
#endif // HAVE_CURL
#ifdef ATRAILERS
    ONLINE_CONTENT_ATRAILERS_ENABLED,
    ONLINE_CONTENT_ATRAILERS_REFRESH,
    ONLINE_CONTENT_ATRAILERS_UPDATE_AT_START,
    ONLINE_CONTENT_ATRAILERS_PURGE_AFTER,
    ONLINE_CONTENT_ATRAILERS_RESOLUTION,
#endif
#ifdef HAVE_FFMPEG
    ...
    A_TRANSCODING_PROFILES_PROFLE_RES,
