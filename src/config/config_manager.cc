...
static std::vector<std::shared_ptr<ConfigSetup>> complexOptions = {
    ...
    std::make_shared<ConfigStringSetup>(ATTR_TRANSCODING_PROFILES_PROFLE_AGENT_COMMAND, "command", true, "", true),
    std::make_shared<ConfigStringSetup>(ATTR_TRANSCODING_PROFILES_PROFLE_AGENT_ARGS, "arguments", true, "", true),
    std::make_shared<ConfigSetup>(ATTR_TRANSCODING_PROFILES_PROFLE_RES, "resolution", false),
