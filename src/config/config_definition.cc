...
const std::vector<std::shared_ptr<ConfigSetup>> ConfigDefinition::complexOptions = {
    std::make_shared<ConfigUIntSetup>(CFG_SERVER_PORT,
    ...
    std::make_shared<ConfigBoolSetup>(CFG_IMPORT_AUTOSCAN_INOTIFY_ATTRIB,
    ...
    std::make_shared<ConfigStringSetup>(ATTR_TRANSCODING_PROFILES_PROFLE_AVI4CC_4CC,
        ...
        ""),
    std::make_shared<ConfigUIntSetup>(ATTR_TRANSCODING_PROFILES_PROFLE_CLIENTFLAGS,
    ...
    std::make_shared<ConfigBoolSetup>(CFG_UPNP_LITERAL_HOST_REDIRECTION,
        ...
        NO),
    std::make_shared<ConfigBoolSetup>(CFG_UPNP_DYNAMIC_DESCRIPTION,
