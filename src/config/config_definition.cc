...
const std::vector<std::shared_ptr<ConfigSetup>> ConfigDefinition::complexOptions = {
    ...
    std::make_shared<ConfigBoolSetup>(ConfigVal::CLIENTS_LIST_ENABLED,
        ...
        NO),
    std::make_shared<ConfigIntSetup>(ConfigVal::CLIENTS_CACHE_THRESHOLD,
    ...
    std::make_shared<ConfigArraySetup>(ConfigVal::IMPORT_VIRTUAL_DIRECTORY_KEYS,
        "/import/virtual-directories", "config-import.html#virtual-directories",
        ConfigVal::A_IMPORT_VIRT_DIR_KEY, ConfigVal::A_IMPORT_VIRT_DIR_METADATA, false, false,
    ...
    std::make_shared<ConfigVectorSetup>(ConfigVal::IMPORT_MAPPINGS_CONTENTTYPE_TO_DLNAPROFILE_LIST,
        ...
        ConfigVal::A_IMPORT_MAPPINGS_MIMETYPE_MAP, std::vector<ConfigVal> { ConfigVal::A_IMPORT_MAPPINGS_MIMETYPE_FROM, ConfigVal::A_IMPORT_MAPPINGS_MIMETYPE_TO },
    ...
    std::make_shared<ConfigDictionarySetup>(ConfigVal::A_TRANSCODING_MIMETYPE_PROF_MAP,
        ...
        ConfigVal::A_TRANSCODING_MIMETYPE_PROF_MAP_TRANSCODE, ConfigVal::A_TRANSCODING_MIMETYPE_PROF_MAP_MIMETYPE, ConfigVal::A_TRANSCODING_MIMETYPE_PROF_MAP_USING,
    ...
    std::make_shared<ConfigDictionarySetup>(ConfigVal::A_TRANSCODING_PROFILES_PROFLE_AGENT_ENVIRON,
        ...
        ConfigVal::A_TRANSCODING_PROFILES_PROFLE_AGENT_ENVIRON_KEY, ConfigVal::A_TRANSCODING_PROFILES_PROFLE_AGENT_ENVIRON_NAME, ConfigVal::A_TRANSCODING_PROFILES_PROFLE_AGENT_ENVIRON_VALUE,
        false, false, false),
    std::make_shared<ConfigStringSetup>(ConfigVal::A_TRANSCODING_PROFILES_PROFLE_RES,
        "resolution", "config-transcode.html#profiles",
        false),
    std::make_shared<ConfigStringSetup>(ConfigVal::A_TRANSCODING_PROFILES_PROFLE_AGENT,
        "agent", "config-transcode.html#profiles",
        true),
...
const std::map<ConfigVal, std::vector<ConfigVal>> ConfigDefinition::parentOptions {
...
const std::map<ConfigVal, ConfigVal> ConfigDefinition::dependencyMap = {
...
const char* ConfigDefinition::mapConfigOption(ConfigVal option)
{
...
bool ConfigDefinition::isDependent(ConfigVal option)
{
    return (dependencyMap.find(option) != dependencyMap.end());
}

std::shared_ptr<ConfigSetup> ConfigDefinition::findConfigSetup(ConfigVal option, bool save)
{
