...
std::vector<std::shared_ptr<ConfigSetup>> ConfigDefinition::getServerOptions()
{
    ...
    // Logging and debugging
        ...
        std::make_shared<ConfigBoolSetup>(ConfigVal::UPNP_DYNAMIC_DESCRIPTION,
            ...
            YES),
        std::make_shared<ConfigUIntSetup>(ConfigVal::UPNP_DYNAMIC_SERVER_FLAGS,
            "/server/upnp/attribute::server-flags", "config-server.html#confval-server-flags",
            ClientConfig::makeFlags("SAMSUNG|DCM10"), ClientConfig::makeFlags, ClientConfig::mapFlags),
        ...
        std::make_shared<ConfigBoolSetup>(ConfigVal::UPNP_SEARCH_FILENAME,
            ...
            NO),
        std::make_shared<ConfigIntSetup>(ConfigVal::UPNP_SEARCH_NESTING_LIMIT,
            "/server/upnp/attribute::search-nesting-limit", "config-server.html#confval-search-nesting-limi",
            32, 5, ConfigIntSetup::CheckMinValue),
...
std::vector<std::shared_ptr<ConfigSetup>> ConfigDefinition::getImportOptions()
{
    ...
    return {
        ...
        std::make_shared<ConfigEnumSetup<ImportMode>>(ConfigVal::IMPORT_LAYOUT_MODE,
            ...
            AutoscanDirectory::remapImportMode, AutoscanDirectory::mapImportMode),
    ...
    // Autoscan settings
        ...
        std::make_shared<ConfigEnumSetup<ImportMode>>(ConfigVal::A_AUTOSCAN_DIRECTORY_LAYOUT_MODE,
            "attribute::import-mode", "config-import.html#confval-directory-import-mode",
            ImportMode::MediaTomb,
            AutoscanDirectory::remapImportMode, AutoscanDirectory::mapImportMode),
