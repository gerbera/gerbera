...
{
    if (entryType == CdsEntryType::Directory || entryType == CdsEntryType::VirtualContainer || entryType == CdsEntryType::DynamicFolder || entryType == CdsEntryType::ExtraDirectory || entryType == CdsEntryType::PlaylistContainer) {
...
static const auto entryTypes = std::map<CdsEntryType, std::string> {
    ...
    { CdsEntryType::PlaylistContainer, "PlaylistContainer" },
};
