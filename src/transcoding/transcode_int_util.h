...
private:
    ...
    bool createVideoBufferSource(const std::string& name);
    bool createVideoBufferSink(const std::string& name);

    bool createAudioBuffers();
    bool createAudioBufferSource(const std::string& name);
    bool createAudioBufferSink(const std::string& name);
...
public:
    ...
    operator bool() { return dec_ctx && dec_frame; };
};
