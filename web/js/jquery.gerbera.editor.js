...
(function ($) {
  ...
  function addNewItem (modal, itemData) {
    ...
    var editObjectType = modal.find('#editObjectType')
    var editTitle = modal.find('#editTitle')
    var editLocation = modal.find('#editLocation')
    var editClass = modal.find('#editClass')
    var editDesc = modal.find('#editDesc')
    var editMime = modal.find('#editMime')
    var editActionScript = modal.find('#editActionScript')
    var editState = modal.find('#editState')
    var editProtocol = modal.find('#editProtocol')
    var saveButton = modal.find('#editSave')

    reset(modal)

    editObjectType.off('click').on('click', function () {
      var editObjectType = $(this)
  ...
  function saveItem (modal) {
    var item
    var objectId = modal.find('#objectId')
    var editObjectType = modal.find('#editObjectType')
    var editTitle = modal.find('#editTitle')
    var editLocation = modal.find('#editLocation')
    var editDesc = modal.find('#editDesc')
  ...
  function addObject (modal) {
    var item
    var parentId = modal.find('#addParentId')
    var editObjectType = modal.find('#editObjectType')
    var editClass = modal.find('#editClass')
    var editTitle = modal.find('#editTitle')
    var editLocation = modal.find('#editLocation')
