...
_gerbera_completions() {
    ...
    commands="${commands} --help --debug --version --compile-info --create-config --create-example-config --check-config --print-options --offline --daemon --user --pidfile --config --cfgdir --logfile --rotatelog --syslog --add-file --set-option --port --ip --interface --home --magic --import-mode --debug-mode"
